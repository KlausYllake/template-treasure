...
menino = createSprite(width/2,height-height/4,20,20);
...
function draw() {
  ...
  fill("yellow");
  stroke("black");
  text("Tesouros: "+ colecaoTesouros,width/2.35,30);
  }
...
function criarDinheiro() {
  ...
  var dinheiro = createSprite(Math.round(random(width/4, width-width/4),40, 10, 10));
...
function criarDiamantes() {
  ...
  var diamantes = createSprite(Math.round(random(width/4, width-width/4),40, 10, 10));
...
function criarJoias() {
  ...
  var joias = createSprite(Math.round(random(width/4, width-width/4),40, 10, 10));
...
function criarEspadas(){
  ...
  var espada = createSprite(Math.round(random(width/4, width-width/4),40, 10, 10));
